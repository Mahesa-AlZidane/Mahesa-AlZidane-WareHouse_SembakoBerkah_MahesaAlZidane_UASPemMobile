...
import 'package:warehousing_BerkahSembako/models/stock_model.dart';
import 'package:warehousing_BerkahSembako/controllers/stock_controller.dart';
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<Stock> filteredStocks = stocks
                      .where((stock) => stock.issuer == 'MahesaAz')
                      .toList();
