...
import 'package:warehousing_BerkahSembako/controllers/product_controller.dart';
import 'package:warehousing_BerkahSembako/models/product_model.dart';
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<Product> filteredProducts = products
                      .where((product) => product.issuer == 'MahesaAz')
                      .toList();
