...
import 'package:warehousing_BerkahSembako/controllers/sales_controller.dart';
import 'package:warehousing_BerkahSembako/models/sales_model.dart';
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<Sales> filteredsales =
                      sales.where((sale) => sale.issuer == 'MahesaAz').toList();
